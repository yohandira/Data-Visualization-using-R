...
product_category_gender_plot <- product_category_gender %>%
  ...
  labs(
    ...
    caption = "Source: Yohandira. (2021). Marketing Mix Factors Influencing Purchase Decisions on Bukalapak. IPB University Scientific Repository. https://repository.ipb.ac.id/handle/123456789/106826"
  ) +
  # Set themes
...
show(product_category_gender_plot)
